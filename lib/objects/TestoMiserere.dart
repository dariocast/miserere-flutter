...
class StrofaTestoMiserere {
  ...
  factory StrofaTestoMiserere.fromJson(Map<String, dynamic> json) {
    return StrofaTestoMiserere(
        cantato: json['cantato'],
        letto: json['letto']
    );
  }
}